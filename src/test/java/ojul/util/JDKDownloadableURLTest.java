...
public class JDKDownloadableURLTest {
	...
	public void testGetDownloadURL() {
		 ...
		 * 'http://www.oracle.com/technetwork/java/javase/downloads/jdk9-downloads-3848520.html'
		 */
		final String expected = "http://www.oracle.com/technetwork/java/javase/downloads/jdk9-downloads-3848520.html";
	...
	public void testJDKDetails() {
		 ...
		 */
		final JavaDetails jdkDetails1 = new JavaDetails();
		jdkDetails1.setFileName("jdk-9.0.1_linux-x64_bin.rpm");
		jdkDetails1.setFilepath(
		        "http://download.oracle.com/otn-pub/java/jdk/9.0.1+11/jdk-9.0.1_linux-x64_bin.rpm");
		jdkDetails1.setSHA256(
		        "e93ddb7de5f03b1713ca4161517a24baf8c61e11bd735f52967ca45f996d9b8e");
		jdkDetails1.setSize("304.99 MB");
		jdkDetails1.setTitle("Linux");
		jdkDetails1.setVersion("9.0.1");
		
		Assert.assertTrue(
		        this.jdkDownloadableURL.getJdkDetails().get(0).equals(jdkDetails1));
		
		final JavaDetails jdkDetails2 = new JavaDetails();
		jdkDetails2.setFileName("jdk-9.0.1_linux-x64_bin.tar.gz");
		jdkDetails2.setFilepath(
		        "http://download.oracle.com/otn-pub/java/jdk/9.0.1+11/jdk-9.0.1_linux-x64_bin.tar.gz");
		jdkDetails2.setSHA256(
		        "2cdaf0ff92d0829b510edd883a4ac8322c02f2fc1beae95d048b6716076bc014");
		jdkDetails2.setSize("338.11 MB");
		jdkDetails2.setTitle("Linux");
		jdkDetails2.setVersion("9.0.1");
		
		Assert.assertTrue(
		        this.jdkDownloadableURL.getJdkDetails().get(1).equals(jdkDetails2));
	}
}
