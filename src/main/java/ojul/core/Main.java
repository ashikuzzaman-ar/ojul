/**
 * OJUL(Oracle Java Updater for Linux) is free software: you can redistribute it
 * and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * OJUL(Oracle Java Updater for Linux) is distributed in the hope that it will
 * be useful,
 ...
 * along with OJUL(Oracle Java Updater for Linux). If not, see
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (checkUpdateAvailability.isUpdateAvailable() > 0) {
				...
				System.out.println(
						"Installed JAVA version is : " + checkUpdateAvailability.getLocalJavaVersion());
				...
				System.out.println("You will need to download " + downloader.getJavaDetails().getSize()
						+ " of archive file.");
				System.out.println(
